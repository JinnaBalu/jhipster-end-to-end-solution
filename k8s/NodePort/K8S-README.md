...
```
$ docker image tag app dockerhub.richrelevance.com/app
$ docker push dockerhub.richrelevance.com/app
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n algo_ns
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n algo_ns
```
...
```
$ kubectl get svc jhipster-prometheus -n algo_ns
```
...
```
$ kubectl get svc jhipster-grafana -n algo_ns
```
